...
insert into CRD1(id,parentId,type,name,address, dfltAddr) values(CRD1_S.nextval,1,'B','default','shanghai','N');
insert into CRD1(id,parentId,type,name,address, dfltAddr) values(CRD1_S.nextval,1,'S',null,'shanghai','Y');
